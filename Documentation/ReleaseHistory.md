...
- Build: planned unsigned Release for SideStore re-signing
- Requires: iOS 27.0 or later
- Distribution: prerelease artifact generated by the repository release workflow
...
- Validation status: CI archive, artifact checksum and physical-device Remote Endpoint validation are pending; do not treat this entry as proof of a published or device-verified release.
